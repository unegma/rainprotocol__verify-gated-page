...
export default function Frame({url, c = new THREE.Color(), setModalOpen, setSelectedImage, ...props}: any) {
  ...
  return (
    <group {...props}>
      ...
      <Text
        ...
        maxWidth={0.1} anchorX="left" anchorY="top" position={[0.55, GOLDENRATIO+-0.25, 0]} fontSize={0.05}
      >
        Buy
      </Text>
    </group>
